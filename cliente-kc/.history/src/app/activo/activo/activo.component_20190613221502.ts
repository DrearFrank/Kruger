...
export class ActivoComponent implements OnInit {
  ...
  getDatosCategoriActivo(): void {
    this.categoriaService.getSdatos().subscribe(atributocategorias => (this.atributocategorias = atributocategorias));
  }

  getDatosActivo(): void {
    this.serviService.getSDatosActivo().subscribe(atributos => (this.atributos = atributos));
  }
